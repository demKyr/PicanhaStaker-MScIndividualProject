...
plt.title("Average Deposit Gas Fee", fontsize=18)
plt.xlabel("Staker", fontsize=16)
plt.ylabel("Value (in $)", fontsize=16)
...
plt.title("Average Request Withdraw Gas Fee", fontsize=18)
plt.xlabel("Staker", fontsize=16)
plt.ylabel("Value (in $)", fontsize=16)
plt.xticks(fontsize=14)
plt.yticks(fontsize=14)
...
plt.title("Average Claim Withdraw Gas Fee", fontsize=18)
plt.xlabel("Staker", fontsize=16)
plt.ylabel("Value (in $)", fontsize=16)
plt.xticks(fontsize=14)
plt.yticks(fontsize=14)
...
plt.title("Average Total Gas Fees for Staking & Unstaking", fontsize=18)
plt.xlabel("Staker", fontsize=16)
plt.ylabel("Total Value (in $)", fontsize=16)
plt.xticks(fontsize=14)
plt.yticks(fontsize=14)
plt.show()
