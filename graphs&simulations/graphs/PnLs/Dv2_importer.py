...
class ApproachD:
    ...
    def show_state(self):
        ...
        print('|StakingEOA =', self.VaultBalances["StakingEOA"])
    ...
    def stakingEOAInjection(self, amount):
        self.VaultBalances['StakingEOA'] += amount
        return


    def stakingEOALeakage(self, amount):
        self.VaultBalances['StakingEOA'] -= amount
        return
    ...
    def stake(self):
        ...
        self.VaultBalances["StakingEOA"] -= stakeFee
    ...
    def unstake(self):
        ...
        currentSharePx = self.sharePx()
        self.VaultBalances['StakingEOA'] -= unstakeFee
        ...
        while(not self.Wqueue.isEmpty()):
            ...
            if(req.isDirectWithdraw):
                ...
                self.VaultBalances['StakingEOA'] += req.amount * self.withdrawFee
        return
    ...
    def pairQueues(self):
        ...
        if(self.Wqueue.Q[self.Wqueue.first].isDirectWithdraw):
            ...
            self.VaultBalances["StakingEOA"] += amount * self.withdrawFee
    ...
    def deposit(self, user, amount):
        ...
        self.VaultBalances['VaultAmount'] += amount
        self.VaultBalances['StakingEOA'] += amount * self.depositFee
        self.VaultBalances["DqueueTotal"] += amount 
    ...
    def withdraw(self, user, amount):
        ...
        if (self.preshares[user]):
            ...
            self.VaultBalances["StakingEOA"] += tempAmount * self.withdrawFee
    ...
    def initialisation(self, initialStakingEOAInjection = 1000):
        currentTimestamp = datetime.timestamp(datetime.now())
        self.Dqueue = queue()
        self.Wqueue = queue()
        self.shares = {}
        ...
        self.stakingEOAInjection(initialStakingEOAInjection)
        print('fee',self.fee)
